<template>
    <div class="container-fluid">
        ...
        <div class="modal" id="keepModal" tabindex="-1" role="dialog" aria-labelledby="keepModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="createKeep">
                            <input type="text" v-model="newKeep.name" placeholder="Give your Keep a Title!" required>
                            <input type="text" v-model="newKeep.description" placeholder="Description" class="ml-2" id="desc">
                            <input type="text" v-model="newKeep.img" placeholder="Add an Image!" class="ml-2" id="img">
                            <div>
                            <input type="checkbox" v-model="newKeep.isPrivate" class="form-check-input" id="privateCheck">
